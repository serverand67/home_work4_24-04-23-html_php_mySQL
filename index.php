...
$experience = [
  [
      ...
      'startDate' => 'февраль 2018',
      'endDate' => 'По настоящее время',
      'responsibilities' => 'Дизайн интерьеров. Составление эскизов. Работа с клиентами. Проектирование.',
  ],
  [
      'name' => 'Дизайнер',
      'startDate' => 'август 2013',
      'endDate' => 'январь 2018',
      'responsibilities' => 'Составление чертежей, эскизов. Оформление документации проектов.',
  ],
  [
      'name' => 'Помошник дизайнера',
      'startDate' => 'сентябрь 2010',
      'endDate' => 'июль 2013',
      'responsibilities' => 'Составление чертежей, эскизов. Оформление проектов.',
  ],
];
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['startDate']; ?> - <span class="w3-tag w3-teal w3-round"><?= $experience[$i]['endDate']; ?></span></h6>
          <p><?= $experience[$i]['responsibilities']; ?></p>
          <hr>
        </div>
        <?php endfor; ?>
      </div>
